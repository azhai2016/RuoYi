...
public interface ProductionCategoryMapper {
        ...
        public List<ProductionCategory> selectCategoryList(ProductionCategory category);
         ...
         * @return 结果
         */
        public int insertCategory(ProductionCategory category);
         ...
         * @return 结果
         */
        public int updateCategory(ProductionCategory category);
         ...
         * @return 结果
         */
        public int updateCategoryChildren(@Param("category") List<ProductionCategory> categories);
         ...
         * @return 结果
         */
        public ProductionCategory checkCategoryNameUnique(@Param("categoryName") String categoryName,
         ...
         * @return 部门列表
         */
        public List<ProductionCategory> selectChildrenCategoryById(Long categoryId);
